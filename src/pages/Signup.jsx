            ...
            <Card className="w-full max-w-[24rem]" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'rgb(226, 232, 240)' }}>
                ...
                <CardBody>
                    <form className="flex flex-col gap-4">
                        ...
                        <Button onClick={signup} style={{ background: mode === 'dark' ? 'rgb(226, 232, 240)' : 'rgb(30, 41, 59)', color: mode === 'dark' ? 'black' : 'white' }}>Signup</Button>
                        <Button onClick={signupWithGoogle} style={{ background: 'rgb(66, 133, 244)', color: 'white' }}>Signup with Google</Button>
